  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/hirotanaka918/todo-app">
        ...
        <MenuLink to="https://github.com/hirotanaka918/todo-app/issues/new">
          <StyledMenuItem>
        ...
        <MenuLink to="https://www.buymeacoffee.com/hirotanaka918">
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/hirotanaka918"
            >
              hirotanaka918
            </a>
          </CreditsContainer>
